...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        writeFile(fileNameInput, content);

        System.out.println("Program completed successfully.");
    }

    private static void writeFile(String fileNameInput, List<String> content) {
    ...
    private static void createFile(String fileNameInput) {
        try {
